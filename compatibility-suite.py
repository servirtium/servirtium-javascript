...
if len(sys.argv) > 1:
    ...
    if sys.argv[1] == "record":
        ...
        servirtium_process = subprocess.Popen(["node", "src/todobackend_compatibility_test.js", "record", realUrl], stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
    elif sys.argv[1] == "playback":
        url = "http://localhost:61417"
        servirtium_process = subprocess.Popen(["node", "src/todobackend_compatibility_test.js", "playback", realUrl], stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
